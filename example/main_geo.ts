//main running script as no proper class is created yet such as viewer.
...
document.body.onload = function()
{
	...
	canvas.id = 'potree_render_area';//added for div accesibility and getting screen measurements
	...
	//callback when layer is available
	...
	//adds the pointcloud to the three scene
	function add(pco: PointCloudOctree): void {
		scene.add(pco);
		pointClouds.push(pco);
	}

	//removes the pointcloud
	...
	//main animation loop
	//no custom edl, no custom renderers, no custom nothing
	//things need to be added here eventually
	function loop()
	{
